...
class Generator(torch.nn.Module):
    ...
    def forward(self,opt,latent):
        ...
        impl_layers.level,self.level_weights = self.hyperlayer_forward(opt,latent,self.hyper_level,opt.arch.layers_level,k0=point_dim,interm_coord=opt.arch.interm_coord,return_weights=True)
